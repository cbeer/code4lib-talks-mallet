...
mallet train-classifier --trainer MaxEnt --input data/mallet/all-talks.mallet --training-portion 0.9 --report train:accuracy test:f1:accepted --output-classifier data/mallet/classifier
